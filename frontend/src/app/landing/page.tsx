      ...
      <section id="how-it-works" className="py-28 border-t border-white/8">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="text-center mt-14">
            <Link href="/" className="inline-flex items-center gap-2 rounded-xl bg-sky-500 px-8 py-4 text-base font-bold text-white hover:bg-sky-400 transition-all shadow-xl shadow-sky-500/25 hover:-translate-y-0.5">
            ...
            {CITIES.map(city => (
              <div key={city.name} className="feature-card group rounded-2xl border border-white/8 bg-white/3 p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="/" className="text-xs font-semibold text-sky-400 opacity-0 group-hover:opacity-100 transition-opacity">
                    Analyse →
                  </Link>
                </div>
