...
export function MonteCarloCard({ data }: MonteCarloCardProps) {
  // BUG FIX: var_5_percent is optional — fall back to worst_case_irr if missing
  const var5 = data.var_5_percent ?? data.worst_case_irr;
    ...
    <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mt-4 flex flex-wrap gap-4">
        <div>
          ...
          <span className="font-medium" title="Value at Risk: 5th percentile IRR">
            {formatPercent(var5)}
          </span>
        </div>
